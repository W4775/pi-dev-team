---
name: to-spec
description: "Turn the current conversation into a spec stored in devteam_state: no interview, just synthesis of what you've already discussed."
...
Write the spec into `devteam_state` (section: spec). Do not create GitHub/GitLab issues.
