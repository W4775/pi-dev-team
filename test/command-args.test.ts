...
test("parseDevteamArgs reads continue from string, array, or full slash line", () => {
  assert.deepEqual(parseDevteamArgs("continue"), {
    trimmed: "continue",
    sub: "continue",
    rest: "",
  });
  assert.deepEqual(parseDevteamArgs("/devteam continue"), {
    trimmed: "continue",
    sub: "continue",
    rest: "",
  });
  ...
  assert.deepEqual(parseDevteamArgs("continue list"), {
    trimmed: "continue list",
    sub: "continue",
    rest: "list",
  });
  assert.deepEqual(parseDevteamArgs("continue 2"), {
    trimmed: "continue 2",
    sub: "continue",
    rest: "2",
  });
